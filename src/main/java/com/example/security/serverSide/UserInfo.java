...
/**
 * The UserInfo in our sample project is a very simple POJO that implements the UserDetails interface
 * and contains the information that we want to hold in our user session.
 */
